...
export function parseSupabaseAuthError(message: string): SupabaseAuthErrorCode | null {
  ...
  if (lower.includes('too_many_requests') || lower.includes('too many')) return 'too_many_requests';
  if (lower.includes('over_email_send_rate_limit')) return 'over_email_send_rate_limit';
  if (lower.includes('user_banned') || lower.includes('banned')) return 'user_banned';
  if (lower.includes('weak_password') || lower.includes('password')) return 'weak_password';
  if (lower.includes('email_exists') || lower.includes('already registered')) return 'email_exists';
