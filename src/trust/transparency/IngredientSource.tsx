      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-gray-700">
            We source from local farms and suppliers whenever possible to ensure freshness and
        ...
        <div>
          ...
          <p className="text-gray-700">
            All ingredients meet our strict quality standards. We use organic produce when available
            and never use artificial preservatives.
          </p>
        </div>
      </div>
    </div>
