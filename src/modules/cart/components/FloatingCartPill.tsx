// Floating cart pill — dock slot child (not independently fixed).
...
export function FloatingCartPill() {
  ...
  return (
    <button
      ...
      disabled={shouldHideFloatingCart}
      tabIndex={shouldShowFloatingCart ? 0 : -1}
      aria-hidden={shouldHideFloatingCart}
      ...
      className={cx(
        ...
        shouldHideFloatingCart && 'pointer-events-none',
      )}
    >
      <span
        aria-hidden="true"
