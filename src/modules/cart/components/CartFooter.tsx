  ...
  return (
    <footer
      className={[
        ...
        'bg-white/96 px-3 pt-2 shadow-[0_-10px_26px_rgba(15,23,42,0.08)] backdrop-blur-2xl',
        'dark:border-white/10 dark:bg-ink-950/96 dark:shadow-[0_-12px_30px_rgba(0,0,0,0.28)]',
        'sm:px-4 sm:pt-2.5',
      ].join(' ')}
          ...
          <>
            <div className="mb-1.5 flex items-center justify-between gap-3">
              ...
              <div className="flex shrink-0 items-center gap-1.5">
                <div className="flex items-center gap-1.5 rounded-full border border-cream-200 bg-cream-50 px-2.5 py-1 text-[10px] font-black text-ink-600 shadow-sm dark:border-white/10 dark:bg-white/5 dark:text-white/70">
                  {checkoutDisabled ? (
                    <Clock3
            ...
            <button
              ...
              className={[
                cartPrimaryCta,
                'group min-h-11 py-2.5 text-sm shadow-[0_10px_24px_rgba(168,69,32,0.22)]',
            ...
            {checkoutDisabled ? (
              <p className="mt-1 truncate text-center text-[10px] font-medium leading-tight text-ink-500 dark:text-white/50">
