...
export const MODIFIER_TEMPLATES: ModifierTemplate[] = [
  {
    ...
    modifiers: [
      ...
      { name: 'Steak', price_adjustment: 3.0, available: true, sort_order: 1 },
      { name: 'Shrimp', price_adjustment: 2.0, available: true, sort_order: 2 },
  ...
  },
  {
    ...
    modifiers: [
      { name: 'Small', price_adjustment: -1.0, available: true, sort_order: 0 },
      { name: 'Medium', price_adjustment: 0, available: true, sort_order: 1 },
      { name: 'Large', price_adjustment: 2.0, available: true, sort_order: 2 },
    ],
  },
  {
    id: 'tmpl-sauces',
    ...
    modifiers: [
      { name: 'Ranch', price_adjustment: 0.5, available: true, sort_order: 0 },
      { name: 'Hot Sauce', price_adjustment: 0.5, available: true, sort_order: 1 },
      { name: 'BBQ', price_adjustment: 0.5, available: true, sort_order: 2 },
      { name: 'Honey Mustard', price_adjustment: 0.5, available: true, sort_order: 3 },
    ],
  },
  {
    id: 'tmpl-add-ons',
    ...
    modifiers: [
      { name: 'Extra Cheese', price_adjustment: 1.0, available: true, sort_order: 0 },
      { name: 'Avocado', price_adjustment: 1.5, available: true, sort_order: 1 },
      { name: 'Bacon', price_adjustment: 1.5, available: true, sort_order: 2 },
    ],
  },
  {
    id: 'tmpl-drink-temp',
...
export const TEMPLATE_CATEGORIES = ['proteins', 'sizes', 'sauces', 'add-ons', 'drinks'] as const;
