...
function computeGrowthSignal(
  revenueRows: DashboardPayload['revenue']['data'],
...
function computeRetentionSignal(
  loyaltyData: DashboardPayload['loyalty']['data'],
): { score: number; delta: number | null } {
...
function computeProfitSignal(
  execData: DashboardPayload['executive']['data'],
): { score: number; delta: number | null } {
...
function computeSafetySignal(
  riskData: DashboardPayload['risk']['data'],
): { score: number; delta: number | null } {
