...
CREATE INDEX growth_campaigns_rotation_idx ON public.growth_campaigns USING btree (placement, active, eligible_for_rotation, is_featured, priority, weight, starts_at, ends_at, updated_at);
