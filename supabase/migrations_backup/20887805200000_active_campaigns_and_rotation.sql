--path: supabase/migrations/20887805200000_active_campaigns_and_rotation.sql

revoke delete on table "public"."auth_audit_log" from "anon";

revoke insert on table "public"."auth_audit_log" from "anon";

revoke references on table "public"."auth_audit_log" from "anon";

revoke select on table "public"."auth_audit_log" from "anon";

revoke trigger on table "public"."auth_audit_log" from "anon";

revoke truncate on table "public"."auth_audit_log" from "anon";

revoke update on table "public"."auth_audit_log" from "anon";

revoke delete on table "public"."auth_audit_log" from "authenticated";

revoke insert on table "public"."auth_audit_log" from "authenticated";

revoke references on table "public"."auth_audit_log" from "authenticated";

revoke select on table "public"."auth_audit_log" from "authenticated";

revoke trigger on table "public"."auth_audit_log" from "authenticated";

revoke truncate on table "public"."auth_audit_log" from "authenticated";

revoke update on table "public"."auth_audit_log" from "authenticated";

revoke delete on table "public"."auth_risk_rate_limits" from "anon";

revoke insert on table "public"."auth_risk_rate_limits" from "anon";

revoke references on table "public"."auth_risk_rate_limits" from "anon";

revoke select on table "public"."auth_risk_rate_limits" from "anon";

revoke trigger on table "public"."auth_risk_rate_limits" from "anon";

revoke truncate on table "public"."auth_risk_rate_limits" from "anon";

revoke update on table "public"."auth_risk_rate_limits" from "anon";

revoke delete on table "public"."auth_risk_rate_limits" from "authenticated";

revoke insert on table "public"."auth_risk_rate_limits" from "authenticated";

revoke references on table "public"."auth_risk_rate_limits" from "authenticated";

revoke select on table "public"."auth_risk_rate_limits" from "authenticated";

revoke trigger on table "public"."auth_risk_rate_limits" from "authenticated";

revoke truncate on table "public"."auth_risk_rate_limits" from "authenticated";

revoke update on table "public"."auth_risk_rate_limits" from "authenticated";

revoke delete on table "public"."auth_risk_scores" from "anon";

revoke insert on table "public"."auth_risk_scores" from "anon";

revoke references on table "public"."auth_risk_scores" from "anon";

revoke select on table "public"."auth_risk_scores" from "anon";

revoke trigger on table "public"."auth_risk_scores" from "anon";

revoke truncate on table "public"."auth_risk_scores" from "anon";

revoke update on table "public"."auth_risk_scores" from "anon";

revoke delete on table "public"."auth_risk_scores" from "authenticated";

revoke insert on table "public"."auth_risk_scores" from "authenticated";

revoke references on table "public"."auth_risk_scores" from "authenticated";

revoke select on table "public"."auth_risk_scores" from "authenticated";

revoke trigger on table "public"."auth_risk_scores" from "authenticated";

revoke truncate on table "public"."auth_risk_scores" from "authenticated";

revoke update on table "public"."auth_risk_scores" from "authenticated";

revoke delete on table "public"."auth_session_validation_cooldowns" from "anon";

revoke insert on table "public"."auth_session_validation_cooldowns" from "anon";

revoke references on table "public"."auth_session_validation_cooldowns" from "anon";

revoke select on table "public"."auth_session_validation_cooldowns" from "anon";

revoke trigger on table "public"."auth_session_validation_cooldowns" from "anon";

revoke truncate on table "public"."auth_session_validation_cooldowns" from "anon";

revoke update on table "public"."auth_session_validation_cooldowns" from "anon";

revoke delete on table "public"."auth_session_validation_cooldowns" from "authenticated";

revoke insert on table "public"."auth_session_validation_cooldowns" from "authenticated";

revoke references on table "public"."auth_session_validation_cooldowns" from "authenticated";

revoke select on table "public"."auth_session_validation_cooldowns" from "authenticated";

revoke trigger on table "public"."auth_session_validation_cooldowns" from "authenticated";

revoke truncate on table "public"."auth_session_validation_cooldowns" from "authenticated";

revoke update on table "public"."auth_session_validation_cooldowns" from "authenticated";

revoke delete on table "public"."auth_sessions_meta" from "anon";

revoke insert on table "public"."auth_sessions_meta" from "anon";

revoke references on table "public"."auth_sessions_meta" from "anon";

revoke select on table "public"."auth_sessions_meta" from "anon";

revoke trigger on table "public"."auth_sessions_meta" from "anon";

revoke truncate on table "public"."auth_sessions_meta" from "anon";

revoke update on table "public"."auth_sessions_meta" from "anon";

revoke delete on table "public"."auth_sessions_meta" from "authenticated";

revoke insert on table "public"."auth_sessions_meta" from "authenticated";

revoke references on table "public"."auth_sessions_meta" from "authenticated";

revoke select on table "public"."auth_sessions_meta" from "authenticated";

revoke trigger on table "public"."auth_sessions_meta" from "authenticated";

revoke truncate on table "public"."auth_sessions_meta" from "authenticated";

revoke update on table "public"."auth_sessions_meta" from "authenticated";

revoke delete on table "public"."device_trust" from "anon";

revoke insert on table "public"."device_trust" from "anon";

revoke references on table "public"."device_trust" from "anon";

revoke select on table "public"."device_trust" from "anon";

revoke trigger on table "public"."device_trust" from "anon";

revoke truncate on table "public"."device_trust" from "anon";

revoke update on table "public"."device_trust" from "anon";

revoke delete on table "public"."device_trust" from "authenticated";

revoke insert on table "public"."device_trust" from "authenticated";

revoke references on table "public"."device_trust" from "authenticated";

revoke select on table "public"."device_trust" from "authenticated";

revoke trigger on table "public"."device_trust" from "authenticated";

revoke truncate on table "public"."device_trust" from "authenticated";

revoke update on table "public"."device_trust" from "authenticated";

revoke delete on table "public"."loyalty_ledger_labels" from "anon";

revoke insert on table "public"."loyalty_ledger_labels" from "anon";

revoke references on table "public"."loyalty_ledger_labels" from "anon";

revoke select on table "public"."loyalty_ledger_labels" from "anon";

revoke trigger on table "public"."loyalty_ledger_labels" from "anon";

revoke truncate on table "public"."loyalty_ledger_labels" from "anon";

revoke update on table "public"."loyalty_ledger_labels" from "anon";

revoke delete on table "public"."loyalty_ledger_labels" from "authenticated";

revoke insert on table "public"."loyalty_ledger_labels" from "authenticated";

revoke references on table "public"."loyalty_ledger_labels" from "authenticated";

revoke select on table "public"."loyalty_ledger_labels" from "authenticated";

revoke trigger on table "public"."loyalty_ledger_labels" from "authenticated";

revoke truncate on table "public"."loyalty_ledger_labels" from "authenticated";

revoke update on table "public"."loyalty_ledger_labels" from "authenticated";

-- =============================================================================
-- REPLAY-SAFETY FIX (constraint)
-- 20260306145544_sync_remote.sql conditionally drops this constraint already.
-- IF EXISTS prevents SQLSTATE 42704 when it is already absent on replay.
-- =============================================================================
alter table "public"."growth_campaign_settings"
  drop constraint if exists "growth_campaign_settings_singleton_chk";
...
-- =============================================================================
-- REPLAY-SAFETY FIX (index removed)
-- This CREATE INDEX referenced columns (placement, eligible_for_rotation,
-- is_featured, priority, weight) that do not exist on growth_campaigns at
-- this point in replay order — they are added by the later canonical migration:
--   20887805200000_active_campaigns_and_rotation.sql
-- That migration creates the index with CREATE INDEX IF NOT EXISTS, so
-- removing it here causes zero schema drift. Keeping it here caused
-- SQLSTATE 42703 (column does not exist) on every shadow DB replay.
-- =============================================================================
