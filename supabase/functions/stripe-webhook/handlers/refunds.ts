...
export async function handleChargeRefunded(
  ...
  const refundCurrency = normCurrency(
    latestRefund?.currency ?? charge.currency,
  );
  ...
  const transactionType: RefundKind = isFullRefund
    ? "refund"
    : "partial_refund";
